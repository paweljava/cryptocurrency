...
import static com.crypto.domain.crypto.service.RateListMapper.rateListMapper;
...
class RateServiceTestMock {
    ...
    private final BianceClient bianceClient = mock(BianceClient.class);
    ...
    private final RateService rateService = new RateService(rateRepositoryPort, bianceClient, cryptoRepositoryPort);
